...
PACKAGE_GOPATH_RLM_GO_CACHE_EAP = $(BASE_DIR_RLM_GO_CACHE_EAP)/.gopath
GOPATH   += $(PACKAGE_GOPATH_RLM_GO_CACHE_EAP)
LOCAL_GOPATH = $(subst $(SPACE),:,$(GOPATH))
BASE_RLM_GO_CACHE_EAP     = $(PACKAGE_GOPATH_RLM_GO_CACHE_EAP)/src/$(MODULE_GO_CACHE_EAP)
...
CGO_LDFLAGS := -Wl,--unresolved-symbols=ignore-all,--export-dynamic,--dynamic-list
#,--dynamic-list-data
